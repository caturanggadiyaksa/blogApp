									...
									<div class="row g-4 p-3 flex-fill">
										...
										<div class="col-sm-6 col-lg-3">
											<div class="card bg-transparent">
												...
												<img class="card-img rounded"
													src="{{ asset('/images/blog/16by9/small/01.html') }}" alt="Card image">
										...
										<div class="col-sm-6 col-lg-3">
											<div class="card bg-transparent">
												<!-- Card img -->
												<img class="card-img rounded"
													src="{{ asset('/images/blog/16by9/small/02.html') }}" alt="Card image">
												<div class="card-body px-0 pt-3">
													<h6 class="card-title mb-0"><a href="#"
										...
										<div class="col-sm-6 col-lg-3">
											<div class="card bg-transparent">
												<!-- Card img -->
												<img class="card-img rounded"
													src="{{ asset('/images/blog/16by9/small/03.jpg') }}" alt="Card image">
												<div class="card-body px-0 pt-3">
													<h6 class="card-title mb-0"><a href="#"
				...
				<div class="nav ms-sm-3 flex-nowrap align-items-center">
					...
					<div class="nav-item dropdown dropdown-toggle-icon-none">
						...
						<ul class="dropdown-menu dropdown-menu-end min-w-auto shadow rounded text-end"
							...
							<li><a class="dropdown-item fw-normal" href="#"><span
        ...
        <div class="container">
            ...
            <div class="row pt-5">
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <img class="light-mode-item" src="{{ asset('/images/logo.svg') }}" alt="logo">
                    <img class="dark-mode-item" src="{{ asset('/images/logo-light.svg') }}" alt="logo">
