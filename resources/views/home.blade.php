						...
						<div class="row">
							...
							<div class="col-12">
								<div class="d-flex align-items-center position-relative">
									<img class="w-60 rounded" src="{{ asset('/images/blog/1by1/01.jpg') }}" alt="product">
									<div class="ms-3">
							...
							<div class="col-12">
								<div class="d-flex align-items-center position-relative">
									<img class="w-60 rounded" src="{{ asset('/images/blog/1by1/02.html') }}" alt="product">
									<div class="ms-3">
							...
							<div class="col-12">
								<div class="d-flex align-items-center position-relative">
									<img class="w-60 rounded" src="{{ asset('/images/blog/1by1/03.html') }}" alt="product">
									<div class="ms-3">
						...
						<div class="row">
							...
							<div class="col-12">
								<div class="d-flex align-items-center position-relative">
									...
									<div class="avatar avatar-lg flex-shrink-0">
										<img class="avatar-img rounded-2" src="{{ asset('/images/avatar/06.jpg') }}" alt="avatar">
									</div>
									<!-- Info -->
									<div class="ms-3">
							...
							<div class="col-12">
								<div class="d-flex align-items-center position-relative">
									<!-- Avatar -->
									<div class="avatar avatar-lg flex-shrink-0">
										<img class="avatar-img rounded-2" src="{{ asset('/images/avatar/08.html') }}" alt="avatar">
									</div>
									<!-- Info -->
									<div class="ms-3">
							...
							<div class="col-12">
								<div class="d-flex align-items-center position-relative">
									<!-- Avatar -->
									<div class="avatar avatar-lg flex-shrink-0">
										<img class="avatar-img rounded-2" src="{{ asset('/images/avatar/04.jpg') }}" alt="avatar">
									</div>
									<!-- Info -->
									<div class="ms-3">
										<p class="mb-1"> <a class="h6 fw-normal stretched-link" href="#"> Supposing so be resolving breakfast am or perfectly.. </a></p>
							...
							<div class="col-12">
								<div class="d-flex align-items-center position-relative">
									<!-- Avatar -->
									<div class="avatar avatar-lg flex-shrink-0">
										<img class="avatar-img rounded-2" src="{{ asset('/images/avatar/05.jpg') }}" alt="avatar">
									</div>
									<!-- Info -->
									<div class="ms-3">
										<p class="mb-1"> <a class="h6 fw-normal stretched-link" href="#"> Supposing so be resolving breakfast am or perfectly.. </a></p>
