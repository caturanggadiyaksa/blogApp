                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card card-body bg-success bg-opacity-10 p-4 h-100">
                                ...
                                <p class="mb-2"><span class="text-primary me-1">0.20%<i
                                            class="bi bi-arrow-up"></i></span>vs last month</p>
                                <div class="mt-auto"><a href="#" class="btn btn-link text-reset p-0 mb-0">View
                                        statement</a></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card card-body bg-info bg-opacity-10 p-4 h-100">
                                ...
                                <p class="mb-2"><span class="text-danger me-1">07<i
                                            class="bi bi-arrow-down"></i></span>from last month</p>
                                <div class="mt-auto"><a href="#" class="btn btn-link text-reset p-0 mb-0">View
                                        analytics</a></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card card-body bg-primary bg-opacity-10 p-4 h-100">
                                ...
                                <p class="mb-2"><span class="text-success me-1">15<i
                                            class="bi bi-arrow-up"></i></span>from last month</p>
                                <div class="mt-auto"><a href="#" class="btn btn-link text-reset p-0 mb-0">Manage
                                        followers</a></div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="avatar avatar-lg">
                                        <img class="avatar-img rounded-circle border border-white border-3 shadow"
                                            src="{{ asset('/images/avatar/03.jpg') }}" alt="">
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-3">
                                ...
                                <div class="col-12">
                                    <ul class="list-group list-group-borderless">
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <p class="h6 mb-0">As it so contrasted oh estimating instrument. Size
                                                like body someone had. Are conduct viewing boy minutes warrant the
                                                expense Tolerably behavior may admit daughters offending her ask
                                                own. Praise effect wishes change way and any wanted. Lively use
                                                looked latter regard had. Do he it part more last in Conduct viewing
                                                boy minutes warrant the expense Tolerably behavior may admit
                                                daughters offending her ask own. Praise effect wishes change way and
                                                any wanted. Lively use looked latter regard had. Do he it part more
                                                last in.</p>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center position-relative">
                                        <img class="w-60 rounded" src="{{ asset('/images/blog/1by1/01.jpg') }}"
                                            alt="product">
                                        <div class="ms-3">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center position-relative">
                                        <img class="w-60 rounded" src="{{ asset('/images/blog/1by1/02.html') }}"
                                            alt="product">
                                        <div class="ms-3">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center position-relative">
                                        <img class="w-60 rounded" src="{{ asset('/images/blog/1by1/03.html') }}"
                                            alt="product">
                                        <div class="ms-3">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center position-relative">
                                        <img class="w-60 rounded" src="{{ asset('/images/blog/1by1/04.html') }}"
                                            alt="product">
                                        <div class="ms-3">
                                            <a href="#" class="h6 stretched-link">7 common mistakes everyone makes
                                                while traveling</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center position-relative">
                                        ...
                                        <div class="avatar avatar-lg flex-shrink-0">
                                            <img class="avatar-img rounded-2" src="{{ asset('/images/avatar/06.jpg') }}"
                                                alt="avatar">
                                        </div>
                                        <!-- Info -->
                                        <div class="ms-3">
                                            <p class="mb-1 h6 fw-normal"> <a class="stretched-link" href="#">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center position-relative">
                                        <!-- Avatar -->
                                        <div class="avatar avatar-lg flex-shrink-0">
                                            <img class="avatar-img rounded-2" src="{{ asset('/images/avatar/08.html') }}"
                                                alt="avatar">
                                        </div>
                                        <!-- Info -->
                                        <div class="ms-3">
                                            <p class="mb-1 h6 fw-normal"> <a class="stretched-link" href="#"> We
                                                    focus a great deal on the understanding of behavioral.. </a></p>
                                            <div class="d-flex justify-content-between">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center position-relative">
                                        <!-- Avatar -->
                                        <div class="avatar avatar-lg flex-shrink-0">
                                            <img class="avatar-img rounded-2" src="{{ asset('/images/avatar/04.jpg') }}"
                                                alt="avatar">
                                        </div>
                                        <!-- Info -->
                                        <div class="ms-3">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center position-relative">
                                        <!-- Avatar -->
                                        <div class="avatar avatar-lg flex-shrink-0">
                                            <img class="avatar-img rounded-2" src="{{ asset('/images/avatar/05.jpg') }}"
                                                alt="avatar">
                                        </div>
                                        <!-- Info -->
                                        <div class="ms-3">
                                ...
                                <table class="table align-middle p-4 mb-0 table-hover table-shrink">
                                    ...
                                    <tbody class="border-top-0">
                                        ...
                                        <tr>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="table-title mt-2 mt-md-0 mb-0"><a href="#">12 worst types
                                                        of business accounts you follow on Twitter</a></h6>
                                            </td>
                                            <!-- Table data -->
                                            <td>Jan 22, 2022</td>
                                            <!-- Table data -->
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-success bg-opacity-10 text-success mb-2">Approve</span>
                                            </td>
                                            <!-- Table data -->
                                            <td>
                                        ...
                                        <tr>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="table-title mt-2 mt-md-0 mb-0"><a href="#">Dirty little
                                                        secrets about the business industry</a></h6>
                                            </td>
                                            <!-- Table data -->
                                            <td>Jan 19, 2022</td>
                                            <!-- Table data -->
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-warning bg-opacity-15 text-warning mb-2">Pending</span>
                                            </td>
                                            <!-- Table data -->
                                            <td>
                                                <div class="d-flex gap-2">
                                        ...
                                        <tr>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="table-title mt-2 mt-md-0 mb-0"><a href="#">7 common
                                        ...
                                        <tr>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="table-title mt-2 mt-md-0 mb-0"><a href="#">5 investment
                                                        doubts you should clarify</a></h6>
                                            </td>
                                            <!-- Table data -->
                                            <td>Jan 22, 2022</td>
                                            <!-- Table data -->
                                        ...
                                        <tr>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="table-title mt-2 mt-md-0 mb-0"><a href="#">Bad habits
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-danger bg-opacity-10 text-danger mb-2">Cancel</span>
                                            </td>
                                            <!-- Table data -->
                                            <td>
                                                <div class="d-flex gap-2">
                                        ...
                                        <tr>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="table-title mt-2 mt-md-0 mb-0"><a href="#">Around the
                                                        web: 20 fabulous infographics about business</a></h6>
                                            </td>
                                            <!-- Table data -->
                                            <td>Jan 22, 2022</td>
                                            <!-- Table data -->
