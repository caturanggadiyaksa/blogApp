          ...
          <div class="col-12">
            <div class="card mb-4 position-relative z-index-9">
              ...
              <div class="py-5 h-200 rounded"
                style="background-image:url({{ asset('/images/blog/16by9/big/07.jpg') }}); background-position: center bottom; background-size: cover; background-repeat: no-repeat;">
              </div>
                    ...
                    <div class="d-flex align-items-center justify-content-center justify-content-md-end">
                      ...
                      <div class="dropdown ms-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                          <li><a class="dropdown-item" href="#"><i class="bi bi-share me-2 fw-icon"></i>Share profile</a>
                          </li>
                          <li><a class="dropdown-item" href="#"><i class="bi bi-volume-mute me-2 fw-icon"></i>Mute
                              notification</a></li>
                          ...
                          <li><a class="dropdown-item" href="#"><i class="bi bi-flag me-2 fw-icon"></i>Report a bug</a>
                          </li>
                        </ul>
                      </div>
                      <!-- Card action END -->
              ...
              <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="position-relative me-3">
                      ...
                      <div class="position-absolute top-0 end-0  z-index-9">
                        <a class="btn btn-sm btn-light btn-round mb-0 mt-n1 me-n1" href="#"> <i class="bi bi-pencil"></i>
                        </a>
                      </div>
                      <!-- Avatar preview -->
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control"
                    rows="3">I’ve found a way to get paid for my favorite hobby, and do so while following my dream of traveling the world.</textarea>
            ...
            <div class="card border mb-4">
              ...
              <div class="card-body">
                ...
                <div class="form-check form-check-md my-3">
                  ...
                  <label class="form-check-label" for="deleteaccountCheck">Yes, I'd really like to delete my
                    account</label>
                </div>
