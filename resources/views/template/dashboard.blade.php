...
<!-- Mirrored from blogzine.webestica.com/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Mar 2023 12:38:17 GMT -->
<head>
	...
	<nav class="navbar navbar-expand-xl">
		<div class="container">
			...
			<a class="navbar-brand me-3" href="index-2.html">
				<img class="navbar-brand-item light-mode-item" src="{{ asset('/images/logo.svg') }}" alt="logo">			
				<img class="navbar-brand-item dark-mode-item" src="{{ asset('/images/logo-light.svg') }}" alt="logo">			
			</a>
			<!-- Logo END -->
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav navbar-nav-scroll mx-auto">
					...
					<!-- Nav item 1 Demos -->
					<li class="nav-item"><a class="nav-link" href="/home"><i class="bi bi-house-door me-1"></i>Dashboard</a></li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="postMenu">
							<!-- dropdown submenu -->
							<li> <a class="dropdown-item" href="post-list">Post List</a> </li>
							<li> <a class="dropdown-item" href="post-categories">Post Categories</a> </li>
							<li> <a class="dropdown-item" href="create-post">Create a Post</a> </li>
							<li> <a class="dropdown-item" href="edit-post">Edit Post</a> </li>
						</ul>
					</li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="pagesMenu">
							<li> <a class="dropdown-item" href="author-list">Author List</a></li>
							<li> <a class="dropdown-item" href="author-single">Author Single</a></li>
			...
			<div class="nav flex-nowrap align-items-center">
										...
										<a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
											<div class="me-3">
												<div class="avatar avatar-sm">
													<img class="avatar-img rounded-circle" src="{{ asset('/images/avatar/08.html') }}" alt="avatar">
												</div>
											</div>
											<div>
				...
				<div class="nav-item ms-2 ms-md-3 dropdown">
					...
					<ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
						...
						<li class="px-3">
							<div class="d-flex align-items-center">
								...
								<div class="avatar me-3">
									<img class="avatar-img rounded-circle shadow" src="{{ asset('/images/avatar/03.jpg') }}" alt="avatar">
								</div>
								<div>
						...
						<!-- Links -->
						<li><a class="dropdown-item" href="edit-profile"><i class="bi bi-person fa-fw me-2"></i>Edit Profile</a></li>
						<li><a class="dropdown-item" href="account-settings"><i class="bi bi-gear fa-fw me-2"></i>Account Settings</a></li>
						<li><a class="dropdown-item" href="#"><i class="bi bi-info-circle fa-fw me-2"></i>Help</a></li>
						<li><a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bi bi-power fa-fw me-2"></i>Sign Out</a></li>
