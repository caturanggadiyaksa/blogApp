        ...
        <div class="row pb-4">
          <div class="col-12">
            ...
            <div class="d-sm-flex justify-content-sm-between align-items-center">
              <h1 class="mb-2 mb-sm-0 h2">Reviews <span class="badge bg-primary bg-opacity-10 text-primary">301</span>
              </h1>
                    ...
                    <tbody class="border-top-0">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <p class="small course-title">Our side fail find like now Discovered travelling for insensible
                            partiality unpleasing impossible she Sudden up my excuse to suffer ladies though or Bachelor
                            possible marianne directly confined relation as on he <a href="#" data-bs-toggle="modal"
                              data-bs-target="#viewReview"> Read more</a> </p>
                        </td>
                        <!-- Table data -->
                        <td>
                        ...
                        <td>
                          <div class="dropdown">
                            <a href="#" class="btn btn-light btn-round mb-0" role="button" id="dropdownReview"
                            ...
                            <ul class="dropdown-menu dropdown-w-sm dropdown-menu-end min-w-auto shadow rounded"
                              ...
                              <li><a class="dropdown-item" href="#"><i class="bi bi-trash fa-fw me-2"></i>Delete</a>
                              </li>
                            </ul>
                          </div>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a href="#" class="btn btn-light btn-round mb-0" role="button" id="dropdownReview2"
                              data-bs-toggle="dropdown" aria-expanded="false">
                              <i class="bi bi-three-dots fa-fw"></i>
                            </a>
                            <!-- dropdown button -->
                            <ul class="dropdown-menu dropdown-w-sm dropdown-menu-end min-w-auto shadow rounded"
                              aria-labelledby="dropdownReview2">
                              <li><a class="dropdown-item" href="#"><i
                                    class="bi bi-pencil-square fa-fw me-2"></i>Edit</a></li>
                              <li><a class="dropdown-item" href="#"><i class="bi bi-trash fa-fw me-2"></i>Delete</a>
                              </li>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <p class="course-title small">course-titleOur side fail find like now Discovered travelling
                            for insensible partiality unpleasing impossible she Sudden up my excuse to suffer ladies
                            though or Bachelor possible marianne directly confined relation as on he <a href="#"
                              data-bs-toggle="modal" data-bs-target="#viewReview"> Read more</a> </p>
                        </td>
                        <!-- Table data -->
                        <td>
                          <div class="form-check form-switch form-check-md">
                        ...
                        <td>
                          <div class="dropdown">
                            <a href="#" class="btn btn-light btn-round mb-0" role="button" id="dropdownReview3"
                              data-bs-toggle="dropdown" aria-expanded="false">
                              <i class="bi bi-three-dots fa-fw"></i>
                            </a>
                            <!-- dropdown button -->
                            <ul class="dropdown-menu dropdown-w-sm dropdown-menu-end min-w-auto shadow rounded"
                              aria-labelledby="dropdownReview3">
                              <li><a class="dropdown-item" href="#"><i
                                    class="bi bi-pencil-square fa-fw me-2"></i>Edit</a></li>
                              <li><a class="dropdown-item" href="#"><i class="bi bi-trash fa-fw me-2"></i>Delete</a>
                              </li>
                      ...
                      <tr>
                        ...
                        <td>
                          <ul class="list-inline mb-2">
                            ...
                            <li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
                            <li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
                            <li class="list-inline-item me-0 small"><i class="fas fa-star text-muted"></i></li>
                            <li class="list-inline-item me-0 small"><i class="fas fa-star text-muted"></i></li>
                          </ul>
                          <p class="course-title small">course-titleOur side fail find like now Discovered travelling
                            for insensible partiality unpleasing impossible she Sudden up my excuse to suffer ladies
                        ...
                        <td>
                          <div class="dropdown">
                            <a href="#" class="btn btn-light btn-round mb-0" role="button" id="dropdownReview4"
                              data-bs-toggle="dropdown" aria-expanded="false">
                              <i class="bi bi-three-dots fa-fw"></i>
                            </a>
                            <!-- dropdown button -->
                            <ul class="dropdown-menu dropdown-w-sm dropdown-menu-end min-w-auto shadow rounded"
                              aria-labelledby="dropdownReview4">
                              <li><a class="dropdown-item" href="#"><i
                                    class="bi bi-pencil-square fa-fw me-2"></i>Edit</a></li>
                              <li><a class="dropdown-item" href="#"><i class="bi bi-trash fa-fw me-2"></i>Delete</a>
                              </li>
                    ...
                    <tbody class="border-top-0">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center position-relative">
                            ...
                            <div>
                              <h6 class="mb-1"><a href="#" class="stretched-link text-reset btn-link">Judy Nguyen</a>
                              </h6>
                            </div>
                          </div>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center position-relative">
                            <div class="avatar avatar-xs me-2">
                              <img class="avatar-img rounded-circle" src="{{ asset('/images/avatar/04.jpg') }}" alt="avatar">
                            </div>
                            <div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center position-relative">
                            ...
                            <div>
                              <h6 class="mb-1"><a href="#" class="stretched-link text-reset btn-link">Amanda Reed</a>
                              </h6>
                            </div>
                          </div>
                        </td>
