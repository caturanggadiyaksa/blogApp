								...
								<div class="d-flex justify-content-between">
									...
									<ul class="avatar-group mb-0">
										<li class="avatar avatar-xs">
											<img class="avatar-img rounded-circle" src="{{ asset('/images/avatar/01.html') }}"
												alt="avatar">
										</li>
										<li class="avatar avatar-xs">
						...
						<div class="card border h-100">
							...
							<div class="card-body p-3">
								...
								<div class="d-flex justify-content-between">
									...
									<ul class="avatar-group mb-0">
										<li class="avatar avatar-xs">
											<img class="avatar-img rounded-circle" src="{{ asset('/images/avatar/07.html') }}"
												alt="avatar">
										</li>
										<li class="avatar avatar-xs">
											<img class="avatar-img rounded-circle" src="{{ asset('/images/avatar/08.html') }}"
												alt="avatar">
										</li>
										<li class="avatar avatar-xs">
											<img class="avatar-img rounded-circle" src="{{ asset('/images/avatar/09.jpg') }}"
												alt="avatar">
										</li>
										<li class="avatar avatar-xs">
											<div class="avatar-img rounded-circle bg-primary"><i
						...
						<div class="card border h-100">
							...
							<div class="card-body p-3">
								...
								<div class="d-flex justify-content-between">
									...
									<ul class="avatar-group mb-0">
										<li class="avatar avatar-xs">
											<img class="avatar-img rounded-circle" src="{{ asset('/images/avatar/10.jpg') }}"
												alt="avatar">
										</li>
										<li class="avatar avatar-xs">
											<img class="avatar-img rounded-circle" src="{{ asset('/images/avatar/11.jpg') }}"
												alt="avatar">
										</li>
										<li class="avatar avatar-xs">
											<img class="avatar-img rounded-circle" src="{{ asset('/images/avatar/12.jpg') }}"
												alt="avatar">
										</li>
										<li class="avatar avatar-xs">
											<div class="avatar-img rounded-circle bg-primary"><i
							...
							<div class="card-header bg-transparent border-bottom p-3">
								<div class="d-sm-flex justify-content-sm-between align-items-center">
									...
									<a href="#" class="btn btn-sm btn-primary mb-0"><i
											class="fas fa-plus me-2"></i>Create a post</a>
								</div>
							</div>
							<!-- Card header END -->
									...
									<table class="table table-dark-gray align-middle p-4 mb-0 table-hover table-shrink">
										...
										<tbody>
											...
											<tr>
												<!-- Table data -->
												<td>
													<h6 class="course-title mt-2 mt-md-0 mb-0"><a href="#">12 worst
															types of business accounts you follow on Twitter</a></h6>
												</td>
												<!-- Table data -->
												<td>
											...
											<tr>
												<!-- Table data -->
												<td>
													<h6 class="course-title mt-2 mt-md-0 mb-0"><a href="#">Dirty little
											...
											<tr>
												<!-- Table data -->
												<td>
													<h6 class="course-title mt-2 mt-md-0 mb-0"><a href="#">5 investment
											...
											<tr>
												<!-- Table data -->
												<td>
													<h6 class="course-title mt-2 mt-md-0 mb-0"><a href="#">Bad habits
												...
												<td>
													<span
														class="badge bg-warning bg-opacity-10 text-warning mb-2">Draft</span>
												</td>
												<!-- Table data -->
												<td>
													<div class="d-flex gap-2">
											...
											<tr>
												<!-- Table data -->
												<td>
													<h6 class="course-title mt-2 mt-md-0 mb-0"><a href="#">Around the
