            ...
            <div class="row g-4 pb-4">
                <div class="col-12">
                    <div class="d-sm-flex justify-content-between align-items-center">
                        ...
                        <a href="#" class="btn btn-sm btn-primary mb-0"><i class="fas fa-plus me-2"></i>Add new
                            author</a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row g-3 align-items-center justify-content-between">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <ul class="list-inline mb-0 nav nav-pills nav-pill-dark-soft border-0 justify-content-end"
                                        ...
                                        <!-- Grid tab -->
                                        <li class="nav-item">
                                            <a href="#nav-list-tab" class="nav-link mb-0 me-2 active"
                                                data-bs-toggle="tab">
                                        ...
                                        <table class="table align-middle p-4 mb-0 table-hover">
                                            ...
                                            <tbody class="border-top-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center position-relative">
                                                            ...
                                                            <div class="avatar avatar-md">
                                                                <img src="{{ asset('/images/avatar/09.jpg') }}"
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge bg-success bg-opacity-10 text-success mb-2">Paid</span>
                                                    </td>
                                                    <!-- Table data -->
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <a href="#" class="btn btn-light btn-round mb-0"
                                                                ...
                                                                title="" data-bs-original-title="Message"
                                                                aria-label="Message">
                                                                <i class="bi bi-envelope"></i>
                                                            </a>
                                                            <a href="#" class="btn btn-light btn-round mb-0"
                                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                                title="" data-bs-original-title="Block"
                                                                aria-label="Block">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center position-relative">
                                                            <!-- Image -->
                                                            <div class="avatar avatar-md">
                                                                <img src="{{ asset('/images/avatar/01.html') }}"
                                                                    class="rounded-circle" alt="">
                                                            </div>
                                                            <div class="mb-0 ms-2">
                                                                <!-- Title -->
                                                                <h6 class="mb-0"><a href="#"
                                                                        class="stretched-link">Carolyn Ortiz</a>
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            ...
                                                            <a href="#" class="btn btn-danger-soft btn-round mb-0"
                                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                                title="" data-bs-original-title="Unblock"
                                                                aria-label="Block">
                                                                <i class="fas fa-ban"></i>
                                                            </a>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center position-relative">
                                                            <!-- Image -->
                                                            <div class="avatar avatar-md">
                                                                <img src="{{ asset('/images/avatar/03.jpg') }}"
                                                                    class="rounded-circle" alt="">
                                                            </div>
                                                            <div class="mb-0 ms-2">
                                                                <!-- Title -->
                                                                <h6 class="mb-0"><a href="#"
                                                                        class="stretched-link">Dennis Barrett</a>
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center position-relative">
                                                            <!-- Image -->
                                                            <div class="avatar avatar-md">
                                                                <img src="{{ asset('/images/avatar/04.jpg') }}"
                                                                    class="rounded-circle" alt="">
                                                            </div>
                                                            <div class="mb-0 ms-2">
                                                                <!-- Title -->
                                                                <h6 class="mb-0"><a href="#"
                                                                        class="stretched-link">Billy Vasquez</a>
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center position-relative">
                                                            <!-- Image -->
                                                            <div class="avatar avatar-md">
                                                                <img src="{{ asset('/images/avatar/05.jpg') }}"
                                                                    class="rounded-circle" alt="">
                                                            </div>
                                                            <div class="mb-0 ms-2">
                                                                <!-- Title -->
                                                                <h6 class="mb-0"><a href="#"
                                                                        class="stretched-link">Jacqueline Miller</a>
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center position-relative">
                                                            <!-- Image -->
                                                            <div class="avatar avatar-md">
                                                                <img src="{{ asset('/images/avatar/06.jpg') }}"
                                                                    class="rounded-circle" alt="">
                                                            </div>
                                                            <div class="mb-0 ms-2">
                                                                <!-- Title -->
                                                                <h6 class="mb-0"><a href="#"
                                                                        class="stretched-link">Amanda Reed</a></h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <!-- Table data -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center position-relative">
                                                            <!-- Image -->
                                                            <div class="avatar avatar-md">
                                                                <img src="{{ asset('/images/avatar/07.html') }}"
                                                                    class="rounded-circle" alt="">
                                                            </div>
                                                            <div class="mb-0 ms-2">
                                                                <!-- Title -->
                                                                <h6 class="mb-0"><a href="#"
                                                                        class="stretched-link">Samuel Bishop</a>
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="avatar avatar-lg me-3 flex-shrink-0">
                                                            <img class="avatar-img rounded-circle"
                                                                src="{{ asset('/images/avatar/10.jpg') }}" alt="">
                                                        </div>
                                                        <!-- Connections holder -->
                                                    ...
                                                    <div class="d-sm-flex justify-content-sm-between mt-3">
                                                        ...
                                                        <div class="d-flex text-start align-items-center mt-3">
                                                            <div
                                                                class="icon-md bg-light text-body rounded-circle flex-shrink-0">
                                            ...
                                            <div class="card border p-2">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="avatar avatar-lg me-3 flex-shrink-0">
                                                            <img class="avatar-img rounded-circle"
                                                                src="{{ asset('/images/avatar/01.html') }}" alt="">
                                                        </div>
                                                        <!-- Connections holder -->
                                                        <div class="flex-grow-1 d-block">
                                            ...
                                            <div class="card border p-2">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="avatar avatar-lg me-3 flex-shrink-0">
                                                            <img class="avatar-img rounded-circle"
                                                                src="{{ asset('/images/avatar/02.jpg') }}" alt="">
                                                        </div>
                                                        <!-- Connections holder -->
                                                        <div class="flex-grow-1 d-block">
                                            ...
                                            <div class="card border p-2">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="avatar avatar-lg me-3 flex-shrink-0">
                                                            <img class="avatar-img rounded-circle"
                                                                src="{{ asset('/images/avatar/04.jpg') }}" alt="">
                                                        </div>
                                                        <!-- Connections holder -->
                                                        <div class="flex-grow-1 d-block">
                                            ...
                                            <div class="card border p-2">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="avatar avatar-lg me-3 flex-shrink-0">
                                                            <img class="avatar-img rounded-circle"
                                                                src="{{ asset('/images/avatar/06.jpg') }}" alt="">
                                                        </div>
                                                        <!-- Connections holder -->
                                                        <div class="flex-grow-1 d-block">
                                            ...
                                            <div class="card border p-2">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="avatar avatar-lg me-3 flex-shrink-0">
                                                            <img class="avatar-img rounded-circle"
                                                                src="{{ asset('/images/avatar/07.html') }}" alt="">
                                                        </div>
                                                        <!-- Connections holder -->
                                                        <div class="flex-grow-1 d-block">
                                            ...
                                            <div class="card border p-2">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="avatar avatar-lg me-3 flex-shrink-0">
                                                            <img class="avatar-img rounded-circle"
                                                                src="{{ asset('/images/avatar/12.jpg') }}" alt="">
                                                        </div>
                                                        <!-- Connections holder -->
                                                        <div class="flex-grow-1 d-block">
                                ...
                                <table class="table align-middle p-4 mb-0 table-hover">
                                    ...
                                    <tbody class="border-top-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#"
                                                    class="btn btn-sm btn-success-soft me-1 mb-1 mb-lg-0">Accept</a>
                                                <a href="#"
                                                    class="btn btn-sm btn-secondary-soft me-1 mb-1 mb-lg-0">Reject</a>
                                                <a href="#" class="btn btn-sm btn-primary-soft me-1 mb-0">View
                                                    App</a>
                                            </td>
                                        </tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center position-relative">
                                                    ...
                                                    <div class="mb-0 ms-2">
                                                        <!-- Title -->
                                                        <h6 class="mb-0"><a href="#"
                                                                class="stretched-link">Jacqueline Miller</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <!-- Table data -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center position-relative">
                                                    ...
                                                    <div class="mb-0 ms-2">
                                                        <!-- Title -->
                                                        <h6 class="mb-0"><a href="#" class="stretched-link">Amanda
                                                                Reed</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <a href="#"
                                                    class="btn btn-sm btn-success me-1 mb-1 mb-md-0 disabled">Accepted</a>
                                                <a href="#" class="btn btn-sm btn-primary-soft me-1 mb-0"
                                                    data-bs-toggle="modal" data-bs-target="#appDetail">View App</a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center position-relative">
                                                    ...
                                                    <div class="mb-0 ms-2">
                                                        <!-- Title -->
                                                        <h6 class="mb-0"><a href="#" class="stretched-link">Samuel
                                                                Bishop</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <a href="#"
                                                    class="btn btn-sm btn-secondary me-1 mb-1 mb-md-0 disabled">Rejected</a>
                                                <a href="#" class="btn btn-sm btn-primary-soft me-1 mb-0"
                                                    data-bs-toggle="modal" data-bs-target="#appDetail">View App</a>
                                            </td>
                                        </tr>
